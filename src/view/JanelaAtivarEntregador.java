...
public class JanelaAtivarEntregador extends JFrame implements ActionListener{
	...
	public JanelaAtivarEntregador() {
		...
		this.setTitle("Ativar Entregador");
	...
	public void actionPerformed(ActionEvent e) {
		...
		if(e.getSource() == btAtivar) {
			if(entregadorController.ativarEntregador(Integer.parseInt(tfCodigo.getText()))) {
