...
public class JanelaDesativarAtendente extends JFrame implements ActionListener{
	...
	public JanelaDesativarAtendente() {
	...
	public void actionPerformed(ActionEvent e) {
		...
		if(e.getSource() == btDesativar) {
			if(atendenteController.ativarAtendente(Integer.parseInt(tfCodigo.getText()))) {
				JOptionPane.showMessageDialog(this, "Atendente ativado com sucesso");
			} else {
				JOptionPane.showMessageDialog(this, "Falha ao ativar atendente");
			}
			limpar();
